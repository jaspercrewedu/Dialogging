class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.lady_macbeth = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'lady_macbeth').setOrigin(0, 1);
        this.lords = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'lords').setOrigin(0, 1);
